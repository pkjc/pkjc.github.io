...
function Card({ children, delay }) {
  return (
    <article
      className={`shadow-sm bg-[#0D1117] overflow-hidden h-8 sm:h-64 flex justify-center items-center rounded-3xl border border-gray-700 relative py-28 sm:py-32 ${delay}`}
    >
      {children}
    </article>
  );
      ...
      >
        ...
        <div className="">
          <p className="text-md leading-7 text-gray-200">
            Hi👋 &nbsp;I'm Pankaj Chobharkar, a software engineer from India,
            currently working in the US. I'm interested in the JAMstack, good
            UX, Table Tennis and Science Fiction.
          </p>
        </div>
